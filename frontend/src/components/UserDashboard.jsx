  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col z-20 shadow-sm shrink-0">
        <div className="h-20 flex items-center gap-3 px-6 border-b border-slate-100 bg-slate-50/30">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          {/* ========================================= */}
          {/* VIEW: CONTACTS (CLEAN LIST + DELETE) */}
          {/* ========================================= */}
          {activeTab === "contacts" && (
          ...
          {/* ========================================= */}
          {/* VIEW: ANALYTICS (STATS + STATUS LOG) */}
          {/* ========================================= */}
          {activeTab === "analytics" && (
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 bg-slate-50 flex gap-3 justify-center">
              <button
                ...
                className="px-6 py-2.5 text-slate-600 font-bold hover:bg-slate-200 bg-slate-100 rounded-xl transition-all"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2.5 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-xl shadow-lg shadow-rose-100 flex items-center gap-2"
              >
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 bg-slate-50 flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-slate-800 hover:bg-slate-900 text-white font-bold rounded-xl shadow-lg flex items-center gap-2"
              >
                <LogOut size={16} />{" "}
...
function NavItem({ icon, label, isActive, onClick }) {
  return (
    <button
      onClick={onClick}
      className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-black text-sm transition-all duration-200 ${isActive ? "bg-indigo-600 text-white shadow-lg shadow-indigo-200 translate-x-2" : "text-slate-400 hover:bg-slate-100 hover:text-slate-600"}`}
    >
      {icon} {label}
    </button>
  );
